...
██   ██ ██   ██  ██████ ██   ██ ███████ ██   ██      ███ ███   ██████  ██   ██ ███████ ██████      ██████  ██████
                  ...
                  YESCOIN AUTO TASK AND PLAY GAME BOT BY HACKER WORLD BD
                    Script channel : https://t.me/HACKER_WORLD_BD
                    Airdrop channel : https://t.me/RXEARNINGBD
                        Note : MUST JOIN MY TELEGRAM CHANNEL
...
def get_invitation(token):
    url = 'https://api-backend.yescoin.gold/invite/getInviteGiftBoxInfoWithCode?inviteCode=GKDBgY'
    headers = get_headers(token)
    try:
        ...
        data = response.json()
        if data['code'] == 0:
            print(f"{Fore.BLUE + Style.BRIGHT} \n -\{Fore.WHITE + Style.BRIGHT} Invited by HACKER WORLD BD {Fore.BLUE + Style.BRIGHT}/-", flush=True)
